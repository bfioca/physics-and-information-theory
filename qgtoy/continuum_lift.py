...
def continuum_lift_obstruction_certificate(
    *,
    ...
    return {
        ...
        "result_type": "conditional_continuum_lift_obstruction_schema",
        "claim_boundary": (
            "conditional lift-obstruction theorem schema only; it does not "
            "construct continuum de Sitter, dS/CFT, or ER=EPR"
        ),
