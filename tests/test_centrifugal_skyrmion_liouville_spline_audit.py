...
from experiments.centrifugal_skyrmion_liouville_spline_audit import (
    OUTPUT,
    build_record,
)


def test_source_hashed_exact_spline_liouville_artifact() -> None:
    ...
    assert "does not yet include" in actual["claim_boundary"]
