#!/usr/bin/env python3
"""Write the source-hashed centrifugal variational-probe artifact."""
...
from qgtoy.centrifugal_skyrmion_variational import (  # noqa: E402
    centrifugal_quadrupole_variational_convergence_record,
)


OUTPUT = ROOT / "experiments/centrifugal_skyrmion_variational_certificate.json"
...
def _source_hashes() -> dict[str, str]:
    paths = (
        ROOT / "experiments/centrifugal_skyrmion_variational_audit.py",
        ROOT / "qgtoy/centrifugal_skyrmion_variational.py",
...
def main() -> None:
    ...
    if _source_hashes() != starting_hashes:
        raise ValueError("variational-probe sources changed during audit")
