#!/usr/bin/env python3
"""Write the source-hashed indicial inverse-majorant certificate."""
...
from qgtoy.centrifugal_skyrmion_indicial_majorant import (  # noqa: E402
...
def _source_hashes() -> dict[str, str]:
    paths = (
        ROOT / "experiments/centrifugal_skyrmion_indicial_majorant_audit.py",
        ROOT / "qgtoy/centrifugal_skyrmion_indicial_majorant.py",
...
def main() -> None:
    ...
    if snapshot_slopes != record["slope_interval"]:
    ...
    if _source_hashes() != starting_hashes:
        raise ValueError("indicial-majorant sources changed during audit")
