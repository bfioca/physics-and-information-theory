#!/usr/bin/env python3
"""Write the source-hashed transformed-origin density certificate."""
...
from qgtoy.centrifugal_skyrmion_transformed_origin import (  # noqa: E402
    centrifugal_transformed_origin_certificate,
)


OUTPUT = ROOT / "experiments/centrifugal_skyrmion_transformed_origin_certificate.json"
...
def _source_hashes() -> dict[str, str]:
    paths = (
        ROOT / "experiments/centrifugal_skyrmion_transformed_origin_audit.py",
...
def main() -> None:
    ...
    if _source_hashes() != starting_hashes:
        raise ValueError("transformed-origin sources changed during audit")
