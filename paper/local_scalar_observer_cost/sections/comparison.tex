...
\cite{RuzhanskySuragan2016}, and logarithmic-potential eigenvalues have been
studied directly in hyperbolic geometry~\cite{JohnsonVerma2026}.  At the
quadratic-form level, odd extension also writes
$P_Lh_0^{-1}\coth(\beta h_0/2)P_L$ as a finite-interval Wiener--Hopf term minus
its Hankel image, generated by the singular even multiplier
