# Specialist Review Response Form

This form records a technical assessment, not endorsement or approval.
...
```text
Blocking proof or physics error:
Closest uncited work:
Required wording correction:
Minimum additional theorem or calculation:
...
STRENGTHEN   Viable after the concrete correction or addition above.
NO-GO        Known, immediate, incorrect, or too routine as a standalone paper.
```

**Decisive reason:**

```text
May the authors identify you as a reviewer of this draft? yes | no
May the authors quote this response privately to another reviewer? yes | no
```

Neither answer grants permission to imply endorsement.
