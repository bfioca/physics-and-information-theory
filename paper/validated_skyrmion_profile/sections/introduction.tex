...
wall, inertia, radial-gap, and inertia-tail outputs.  The trusted implementation
is a substantial exact-rational code base, inventoried in
...
radial gap and spectral tail.  \Cref{sec:reproducibility} identifies the trusted
code base, archives, and reproduction path.  \Cref{sec:discussion} states the
